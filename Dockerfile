...
COPY nginx.conf /etc/COEN6313-Frontend/nginx.conf
...
ADD assignment/ /usr/share/COEN6313-Frontend/assignment/
RUN chmod -R a+r /usr/share/COEN6313-Frontend/assignment/
